...
export function ChatInput({
  ...
  const getPlaceholder = () => {
    switch (mode) {
      ...
      default:
        return 'Scrivi un dubbio su una regola, setup o consiglio...';
    }
  };

  return (
    <div className="max-w-3xl mx-auto w-full px-3 sm:px-4 pb-2 sm:pb-4 shrink-0">
      ...
      <div className="flex items-center gap-1.5 mb-1.5">
        {gameContext ? (
          ...
          <div className="flex items-center gap-1.5 bg-slate-900 border border-slate-700/80 rounded-xl p-1.5 text-xs shadow-lg w-full sm:w-auto">
            <div className="flex items-center gap-1.5 px-2 py-1 bg-slate-800 rounded-lg flex-1 sm:flex-initial">
      ...
      <div className="relative rounded-2xl bg-[#161923] border border-slate-700/80 shadow-xl focus-within:border-amber-500/60 focus-within:ring-1 focus-within:ring-amber-500/30 transition-all">
        <textarea
          ...
          className="w-full bg-transparent text-slate-100 placeholder-slate-400 text-sm px-3.5 py-3 pr-12 resize-none focus:outline-none max-h-36 leading-normal"
        />
